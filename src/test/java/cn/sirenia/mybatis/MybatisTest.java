...
public class MybatisTest {
    ...
    public void selectByExample() {
		...
		List<?> haha = session.selectList("cn.sirenia.mybatis.mapper.UserMapper.test",example);
		//session.select("cn.sirenia.mybatis.mapper.UserMapper.test",example, handler );
